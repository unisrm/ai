...
if __name__ == '__main__':
    inputQueries_, inputSentences_ = getInput("RA291/Ex7_291/resolution/input_291.txt")
    knowledgeBase = KB(inputSentences_)
    knowledgeBase.prepareKB()
    results_ = knowledgeBase.askQueries(inputQueries_)
    printOutput("RA291/Ex7_291/resolution/output_291.txt", results_)
   

-----------------------
2
Friends(Alice,Bob,Charlie,Diana)
Friends(Diana,Alice,Charlie,Bob)
2
Friends(a,b,c,d)
NotFriends(a,b,c,d)
